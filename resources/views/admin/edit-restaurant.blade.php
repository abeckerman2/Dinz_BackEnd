...
">
            ...
            <form class="user">
              ...
              <div class="text-center linwe">
              <img src="{{url('public/admin/img/dummy1.jpg')}}" width="200px" style="" title="Click here to change image">
              <img src="{{url('public/admin/img/dummy1.jpg')}}" width="200px" style="" title="Click here to change image">
              <img src="{{url('public/admin/img/dummy1.jpg')}}" width="200px" style="" title="Click here to change image">
              <img src="{{url('public/admin/img/dummy1.jpg')}}" width="200px" style="" title="Click here to change image">
              <img src="{{url('public/admin/img/dummy1.jpg')}}" width="200px" style="" title="Click here to change image">
            ...
            <div>
              <img src="{{url('public/admin/img/andrewlogo.png')}}" width="200px" style="">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-user" id="exampleInputtext" value="ABC123">
                    </div>
                    <div class="form-group">
                      <label>First Name Of Owner</label>
                      <input type="text" class="form-control form-control-user" id="exampleInputtext" value="Shivam">
                    </div>
                    <div class="form-group">
                      <label>Last Name Of Owner</label>
                      <input type="text" class="form-control form-control-user" id="exampleInputtext" value="Singh">
                    </div>
                     <div class="form-group">
                      <label>Email Address</label>
                      <input type="text" class="form-control form-control-user" id="exampleInputtext" value="shivam@yopmail.com">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-user" id="exampleInputtext" value="+9123456790">
                    </div>
                   <div class="text-center Restaurant">
                    <div>
                    <a href="{{route('admin.approvedRestaurant')}}" class="btn btn-primary btn-user btn-block button_bottom">
                     Update
                    </a>
                  </div>
                  </div>
