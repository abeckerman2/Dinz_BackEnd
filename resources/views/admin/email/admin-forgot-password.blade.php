    ...
    <td align="left" valign="top" style="background:#efefef; padding:30px 20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td align="left" valign="top" style="font-family:arial, sans-serif; font-size:15px; color:#474747;">We have received a request to reset your Dinz account password associate with this email address.<br></br><br>If you have not made this request, you can ignore this email and we assure you that your account is completely secure.</br><br></br><br>
            If you do need to reset your Dinz password, click the button given below.</br>
            </td>
          </tr>
          <tr>
		 ...
		 <tr>
          ...
          <tr>
            <td align="center" valign="top"> <a href="{{$link}}"; style="font-family:arial, sans-serif; font-size:14px; color:#00aeef; background-color: #ed2227; padding: 12px 9px; max-width: 120px; display: block; text-align: center; margin: 0 auto; color: #fff; text-decoration: none;">Click here for reset your password</a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
