						...
						<div class="card-body calender_inputs">
							<div class="d-flex justify-content-between">
								<div class="add_btn" style="position: inherit;">
									<!-- <a href="{{route('restaurant.createOrder')}}">
							...
							<div class="mt-5">
									<a href="{{route('restaurant.orderManagement')}}">
										<button type="button" class="btn btn-warning same_wd_btn" style="width: 146px;">Ongoing Orders</button>
									</a>
									...
									@foreach($order as $row)
										<tr>
											...
											<td class="text-center" style="padding-right: 15px !important;    white-space: nowrap;">
												<a href="{{url('restaurant/present-order-details').'/'.$row->id}}">
