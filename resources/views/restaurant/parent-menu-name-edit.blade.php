						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
							   ...
							   <li class="breadcrumb-item active"><a href="{{route('restaurant.documentManagement')}}">Menu Management</a></li>
								...
								<li class="breadcrumb-item remove_hover">Edit Menu</li>
              ...
              <div class="add_btn create_btn">
                ...
                <div class="add_content">
                    ...
                    <div class="form-group pb-3" style="padding-left: 0;">
                      <input type="text" name="menu_name" maxlength="50" class="form-control block-start-space" value="{{$data->menu_name}}" placeholder="Enter Menu Name"/>
                    </div>
                </div>
