		...
		<div class="main-panel dashboard_panel">
					...
					<div class="navbar_bar">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item remove_hover">Document Management</li>
            ...
            <h1>Document Management</h1>
              ...
              <div class="add_btn create_btn">
                  ...
                  <a href="{{route('restaurant.addDocument')}}">
                  <button type="button" class="btn btn-warning same_wd_btn" style="width: 146px;    margin-bottom: 25px;">Add Document</button>
                </a>
                    ...
                    <div class="table-responsive">
                      <table id="basic-datatables" class="display table table-striped table-hover" >
                        ...
                        <tbody> 
                          ...
                          ?>
                            <td>{{++$i}}</td>
                            <td><img src="{{$rows->qr_code_name}}" style="width: 50px"></td>
                            <td>{{$rows->document_name}}</td>
                            <td>
                              <a href="{{url('restaurant/view-document').'/'.$rows->id}}">
                                <button type="button" class="btn btn-warning same_wd_btn mr-2">View</button>
                              </a>

                              <a href="{{url('restaurant/edit-document').'/'.$rows->id}}">
...
<div id="deleteModel" class="modal fade" role="dialog">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <form method="POST" action="{{route('restaurant.deleteDocument')}}" id="deleteFORM">
      {{@csrf_field()}}
    <input type="hidden" name="delete_item_id" id="delete_item_id">
      ...
      <div class="modal-body">
            ...
            <p id="delete_alert_txt">Are you sure, you want to delete this document?</p>    
