		...
		<div class="main-panel dashboard_panel">
						...
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
							   ...
							   <li class="breadcrumb-item active"><a href="{{route('restaurant.documentManagement')}}">Document Management</a></li>
								...
								<li class="breadcrumb-item remove_hover">Edit Document Details</li>
            ...
            <h1>Edit Document Details</h1>
              ...
              <div class="add_btn create_btn">
                      ...
                      <div class="upload_img">
                        ...
                        ?>
                         ...
                         <div class="user_img" data-toggle="tooltip" data-placement="top" title="Upload Image">
                            <div  class="img-wraps" style="margin-top: 10px">
                ...
                <div class="add_content">
                  <input type="Submit" name="submit" id="submit" value="Update" class="btn btn-warning same_wd_btn">
                </div>
    ...
    <script>
        function readURL(input) {
            if (input.files && input.files[0]) {
              ...
              if(file_type == 'doc'){
                user_img = "{{url('public/restaurant/assets/img/dummy_doc.jpg')}}";
              }
              if(file_type == "pdf"){
                user_img = "{{url('public/restaurant/assets/img/dummy_pdf.png')}}";
              }
              if(file_type == "image"){
                user_img = "{{$data->file}}";
              }
