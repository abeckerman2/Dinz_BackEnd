...
@section('title','Today Orders Details')
@section('content')
					...
					<div class="navbar_bar">
						<nav aria-label="breadcrumb">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><a href="{{route('restaurant.todayOrders')}}">Order Management</a></li>
								<!-- <li class="breadcrumb-item active"><a href="{{route('restaurant.todayOrders')}}">Today Orders</a></li> -->
								<li class="breadcrumb-item remove_hover">Today Orders Details</li>
								<!-- <li class="breadcrumb-item"><a href="#">Library</a></li>
								<li class="breadcrumb-item active" aria-current="page">Data</li> -->
							</ol>
						</nav>
					</div>
					<h1>Today Orders Details</h1>
					<div class="card">
