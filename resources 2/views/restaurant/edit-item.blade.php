				...
				<div class="page-inner" style="padding-right: 12px;">
					...
					<div class="card">
						<div class="card-body add_imgae_box">
							...
							<input type="hidden" name="item_type" id="item_type" value="{{$menu_find->item_type}}">
							<div class="user_img" style="width: 12%;
							margin: auto; position: relative;" data-toggle="tooltip" data-placement="right" title="Click to change Image" data-original-title="Change Image">
								<img id="item_image" src="{{$menu_find->image}}" alt="woman" style="margin: 12px 0 12px;">
								<div class="add_img">
							...
							<div class="add_content">
									...
									<div class="form-group pb-3">
										<input type="text" name="item_name" maxlength="50" value="{{$menu_find->item_name}}" class="form-control" placeholder="Enter Item Name"/>
									</div>
							</div>
							<div class="add_content">
									<label for="" class="pb-1">
									...
									<div class="selectdiv mb-3">
										<select class="form-control form-group" style="padding: .6rem 1rem; position: relative;" name="category_id" id="exampleFormControlSelect1">
											...
											<option value="{{$category->id}}" @if($menu_find->category_id == $category->id) selected="selected" @endif()>{{$category->category_name}}</option>
											@endforeach()
							...
							<div class="text-center mt-2">
								...
								<button type="submit" id="submit_btn" class="btn btn-warning same_wd_btn mb-2">Update</button>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        let old_image = "{{$menu_find->image}}";
        if(old_image.length > 0){
        	$("#item_file").attr("img","true"); 
        }
