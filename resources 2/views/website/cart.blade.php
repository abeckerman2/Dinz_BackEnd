              ...
              @foreach($cart_menu_details as $row)
               ...
               <div class="d-flex trip">
                  ...
                  <div class="" id="check_is_tip" style="display: flex;">
                     ...
                     <input type="text" name="" id="customize_tip_amount" class="custom_tip_class" placeholder="Enter Tip" >
  ...
  $(document).ready(function(){
    ...
    $('#customize_tip_amount').on('keyup' , function(){
        ...
        if(new_tip_amount == ""){
            ...
            $('#tip').val(0);
            $('#final_amount_without_tip').val(final_amount);

            $('#change-tip').text('$'+0);
            $('#change-final-amount').text('$'+final_amount);
        }
        else{
